...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED =
            "cdp.t9.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED =
            "cdp.t9.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED =
            "cdp.t9.ACTION_GATT_SERVICES_DISCOVERED";
    ...
    public final static UUID UUID_FBL770_PIOREAD_NOTIFY =
            UUID.fromString(GattAttributes.FBL770_PIOREAD_NOTIFY);

    public final static UUID UUID_FBL770_ADC0_NOTIFY =
            UUID.fromString(GattAttributes.FBL770_ADC0_NOTIFY);

    public final static UUID UUID_FBL770_ADC1_NOTIFY =
            UUID.fromString(GattAttributes.FBL770_ADC1_NOTIFY);

    public final static UUID UUID_FBL770_INIT_SETTING =
            UUID.fromString(GattAttributes.FBL770_INIT_SETTING);

    public final static UUID UUID_FBL770_SPP_WRITE =
            UUID.fromString(GattAttributes.FBL770_SPP_WRITE);

    public final static UUID UUID_FBL770_SPP_NOTIFY =
            UUID.fromString(GattAttributes.FBL770_SPP_NOTIFY);
    ...
    private void broadcastUpdate(final String action,
        ...
        if (UUID_FBL770_INIT_SETTING.equals(characteristic.getUuid())) {
